...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{conway2d/thumbnail_i60}
...
\begin{figure}[H]
    ...
    \caption{Cantidad de celdas vivas en función de la densidad inicial de celdas vivas para el sistema de Conway 2D}
...
Además, se ha estudiado la variación de la cantidad de celdas vivas en función de la densidad inicial de celdas vivas,
...
\begin{figure}[H]
    ...
    \caption{Variación de la cantidad de celdas vivas en función de la densidad inicial de celdas vivas para el sistema de Conway 2D}
    \label{fig:conway2d_size_slope_vs_input}
\end{figure}

Se puede comprobar en la fig. \ref{fig:conway2d_size_slope_vs_input} que la variación de la cantidad de celdas vivas es negativa
...
\begin{figure}[H]
    ...
    \caption{Tiempo de finalización en función de la densidad inicial de celdas vivas para el sistema de Conway 2D}
    \label{fig:conway2d_time_vs_input}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{conway2d/distance_slope_vs_input}
    \caption{Rapidez de alejamiento de la celda viva más lejana al centro en función de la densidad inicial de celdas vivas para el sistema de Conway 2D}
...
sino que también se agregaron corridas con el parámetro valiendo 0.05 y 0.15.

A continuación, podemos observar cómo evoluciona la cantidad de celdas vidas en función del tiempo para distintos valores del parámetro $initialLiveCellsProportion$.
...
La parte interesante de este sistema no radica en la cantidad de celdas vivas en el momento de equilibrio debido a que si utilizamos
$initialLiveCellsProportion > 0.15$ obtendremos siempre la misma cantidad. Es por esto que hacemos hincapie en el crecimiento de cantidad de células vivas.

A continuación, visualizamos el análisis del observable

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{cuarentena2d/observable}
    \caption{Variación de la cantidad de celdas vivas en función de la densidad inicial de celdas vivas para el sistema Cuarentena 2D}
    \label{fig:cuarentena2d_observable}
\end{figure}

Se puede observar en la fig. \ref{fig:cuarentena2d_observable} que se alcanza un máximo en la pendiente de 
crecimiento cuando $initialLiveCellsProportion = 0.6$ 
...
Variando el parámetro $initialLiveCellsProportion$ entre 0.1 y 0.9 con un paso de 0.1, se ha analizado la cantidad de celdas vivas en función
del tiempo.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{circular2d/size_i10}
    \caption{Cantidad de celdas vivas en el tiempo del sistema de Expansión circular en 2D con $initialLiveCellsProportion = 0.1$}
    \label{fig:circular2d_i10}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{circular2d/size_i80}
    \caption{Cantidad de celdas vivas en el tiempo del sistema de Expansión circular en 2D con $initialLiveCellsProportion = 0.8$}
...
Por otro lado, sí es interesante utilizar como observable la cantidad de celdas vivas en el instante final de la simulación. 
A continuación se grafica este mismo en función del valor de $initialLiveCellsProportion$.


\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{circular2d/observable}
    \caption{Cantidad de celdas vivas en función de la densidad inicial de celdas vivas para el sistema Expansión circular en 2D}
    \label{fig:circular2d_observable}
\end{figure}

Se puede observar en la fig. \ref{fig:circular2d_observable} que la cantidad de celdas vivas aumenta, a
medida que lo hace la densidad inicial de celdas vivas.


\subsection{Expansión cúbica en 3D}\label{subsec:cubito-3D}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{cubo3d/thumbnail}
    \caption{Fotograma de la animación de Expansión cúbica en 3D con $initialLiveCellsProportion = 0.9$. Link al video, ver \ref{subsubsec:cubito-3d-link}}
    \label{fig:thumbnailcubo3d_i90}
\end{figure}

El objetivo de este sistema es crecer en cada paso una posición más alejada del centro, pero con la limitación de que la cantidad de celdas vivas no crezca en todos los pasos.

\begin{itemize}
    \item $border = (0, 0, 0) \times (50, 50, 50)$
    \item $condition = MOORE$
    \item $r = 1$
    \item $shouldKeepAlive = [0, 1, 2, 3, 4, 5, 6, 7, 8]$
    \item $shouldRevive = [1, 2, 3]$
...
\begin{figure}[H]
    ...
    \caption{Cantidad de celdas vivas en el tiempo del sistema de Expansión cúbica en 3D con $initialLiveCellsProportion = 0.1$}
    \label{fig:cubo3d_i10}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{cubo3d/size_i80}
    \caption{Cantidad de celdas vivas en el tiempo del sistema de Expansión cúbica en 3D con $initialLiveCellsProportion = 0.8$}
...
Debido a la naturaleza del crecimiento resulta interesante analizar la variación en la cantidad de celdas vivas en función de la densidad inicial de celdas vivas.


\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{cubo3d/observable}
    \caption{Variación de la cantidad de celdas vivas en función de la densidad inicial de celdas vivas para el sistema Expansión circular en 2D}
    \label{fig:cubo3d_observable}
\end{figure}

Se puede observar en la fig. \ref{fig:cubo3d_observable} que la pendiente de crecimiento es positiva, 
pero decrementa a medida que se aumenta la densidad inicial de celdas vivas.

\subsection{Conway en 3D}\label{subsec:conway-en-3d}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{conway3d/thumbnail_i50}
...
\begin{figure}[H]
    ...
    \caption{Cantidad de celdas vivas en función de la densidad inicial de celdas vivas para el sistema de Conway 3D}
...
También se ha estudiado la variación de la cantidad de celdas vivas en función de la densidad
...
\begin{figure}[H]
    ...
    \caption{Variación de la cantidad de celdas vivas en función de la densidad inicial de celdas vivas para el sistema de Conway 3D}
    \label{fig:conway3d_size_slope_vs_input}
\end{figure}

Se puede comprobar en la fig. \ref{fig:conway3d_size_slope_vs_input} que la variación en la cantidad de celdas vivas es positiva
...
\begin{figure}[H]
    ...
    \caption{Tiempo de finalización en función de la densidad inicial de celdas vivas para el sistema de Conway 3D}
    \label{fig:conway3d_time_vs_input}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{conway3d/distance_slope_vs_input}
    \caption{Rapidez de alejamiento de la celda viva más lejana al centro en función de la densidad inicial de celdas vivas para el sistema de Conway 3D}
...
Por otro lado, en la fig. \ref{fig:conway3d_distance_slope_vs_input}, se puede comprobar que la rapidez de alejamiento
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{collapse3d/thumbnail_i30}
...
puede comprobar que la cantidad de celdas vivas es casi nula en el equilibrio, y existe una diferencia de tres
órdenes de magnitud en la cantidad de pasos temporales necesarios para
alcanzar el equilibrio entre ambos.
Es por ello que se decidió estudiar la cantidad de celdas vivas en el equilibrio (eq. \ref{eq:cantidad-celdas-vivas})
y su variación en la cantidad de celdas vivas (eq. \ref{eq:pendiente-crecimiento-celdas-vivas}),
...
\begin{figure}[H]
    ...
    \caption{Cantidad de celdas vivas en función de la densidad inicial de celdas vivas para el sistema de Colapso Cúbico}
    \label{fig:colapso3d_size_vs_input}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{collapse3d/size_slope_vs_input}
    \caption{Variación de la cantidad de celdas vivas en función de la densidad inicial de celdas vivas para el sistema de Colapso Cúbico}
...
de $\frac{60}{50 \times 50 \times 50} \times 100 = 0.048\%$.
...
\begin{figure}[H]
    ...
    \caption{Rapidez de alejamiento de la celda viva más lejana al centro en función de la densidad inicial de celdas vivas para el sistema de Colapso Cúbico}
