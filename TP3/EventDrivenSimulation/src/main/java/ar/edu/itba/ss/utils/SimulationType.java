...
public enum SimulationType {
    OBSTACLE {
        ...
        public Simulation createSimulation(InputData inputData) {
            return new ObstacleSimulation(inputData.getPlane(), inputData.getN(), inputData.getMaxTime(), inputData.getObstacles());
        }
    },
    BIG_PARTICLE {
        @Override
        public Simulation createSimulation(InputData inputData) {
            return new BigParticleSimulation(inputData.getPlane(), inputData.getN(), inputData.getMaxTime(), inputData.getParticles());
        }
    };
